...
Version  : 23
Release  : 29
URL      : http://localhost/cgit/projects/init-rdahead/snapshot/init-rdahead-23.tar.gz
Source0  : http://localhost/cgit/projects/init-rdahead/snapshot/init-rdahead-23.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1535065890
make  %{?_smp_mflags}
