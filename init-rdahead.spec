...
Version  : 26
Release  : 33
URL      : http://localhost/cgit/projects/init-rdahead/snapshot/init-rdahead-26.tar.gz
Source0  : http://localhost/cgit/projects/init-rdahead/snapshot/init-rdahead-26.tar.gz
...
%prep
%setup -q -n init-rdahead-26
cd %{_builddir}/init-rdahead-26
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1632772153
...
cp %{_builddir}/init-rdahead-26/LICENSE %{buildroot}/usr/share/package-licenses/init-rdahead/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
