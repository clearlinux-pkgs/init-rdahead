...
Version  : 28
Release  : 34
URL      : http://localhost/cgit/projects/init-rdahead/snapshot/init-rdahead-28.tar.gz
Source0  : http://localhost/cgit/projects/init-rdahead/snapshot/init-rdahead-28.tar.gz
...
%prep
%setup -q -n init-rdahead-28
cd %{_builddir}/init-rdahead-28
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671209358
