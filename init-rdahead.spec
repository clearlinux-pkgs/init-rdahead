...
Version  : 30
Release  : 36
URL      : http://localhost/cgit/projects/init-rdahead/snapshot/init-rdahead-30.tar.gz
Source0  : http://localhost/cgit/projects/init-rdahead/snapshot/init-rdahead-30.tar.gz
...
%prep
%setup -q -n init-rdahead-30
cd %{_builddir}/init-rdahead-30
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671211782
